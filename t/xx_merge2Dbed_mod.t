...
$exp = [
	...
	[ '1', '',  'X', "$plugin_path/data/IKZF1.tiny.bed" ],
	[ '3', 'X', '',  "$plugin_path/data/EBF1.tiny.bed" ],
	[
		'4', 'X', 'X',
		"$plugin_path/data/EBF1.tiny.bed|$plugin_path/data/IKZF1.tiny.bed"
	]
