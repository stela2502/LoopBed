# This Makefile is for the LoopBed extension to perl.
#
...
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     EXE_FILES => [q[bin/merge2Dbed_mod.pl]]
#     NAME => q[LoopBed]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION => q[0.1]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/LoopBed/AddCols.pm \
	lib/LoopBed/DPlist.pm \
	lib/LoopBed/DoublePeak.pm \
	lib/LoopBed/Peak.pm
...
TO_INST_PM = lib/LoopBed/AddCols.pm \
	lib/LoopBed/DPlist.pm \
	lib/LoopBed/DoublePeak.pm \
	lib/LoopBed/Peak.pm
...
manifypods : pure_all config  \
	lib/LoopBed/AddCols.pm \
	lib/LoopBed/DPlist.pm \
	lib/LoopBed/DoublePeak.pm \
	lib/LoopBed/Peak.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  lib/LoopBed/AddCols.pm $(INST_MAN3DIR)/LoopBed::AddCols.$(MAN3EXT) \
	  lib/LoopBed/DPlist.pm $(INST_MAN3DIR)/LoopBed::DPlist.$(MAN3EXT) \
	  lib/LoopBed/DoublePeak.pm $(INST_MAN3DIR)/LoopBed::DoublePeak.$(MAN3EXT) \
	  lib/LoopBed/Peak.pm $(INST_MAN3DIR)/LoopBed::Peak.$(MAN3EXT) 
...
EXE_FILES = bin/merge2Dbed_mod.pl

pure_all :: $(INST_SCRIPT)/merge2Dbed_mod.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/merge2Dbed_mod.pl 

$(INST_SCRIPT)/merge2Dbed_mod.pl : bin/merge2Dbed_mod.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/merge2Dbed_mod.pl
	$(CP) bin/merge2Dbed_mod.pl $(INST_SCRIPT)/merge2Dbed_mod.pl
	$(FIXIN) $(INST_SCRIPT)/merge2Dbed_mod.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/merge2Dbed_mod.pl
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: LoopBed' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "LoopBed",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="LoopBed" VERSION="0.1">' > LoopBed.ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT></ABSTRACT>' >> LoopBed.ppd
	$(NOECHO) $(ECHO) '    <AUTHOR></AUTHOR>' >> LoopBed.ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> LoopBed.ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.26" />' >> LoopBed.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> LoopBed.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> LoopBed.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> LoopBed.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'lib/LoopBed/AddCols.pm' 'blib/lib/LoopBed/AddCols.pm' \
	  'lib/LoopBed/DPlist.pm' 'blib/lib/LoopBed/DPlist.pm' \
	  'lib/LoopBed/DoublePeak.pm' 'blib/lib/LoopBed/DoublePeak.pm' \
	  'lib/LoopBed/Peak.pm' 'blib/lib/LoopBed/Peak.pm' 
